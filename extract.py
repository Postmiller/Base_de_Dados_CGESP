...
class Extracao:
    ...
    def executar_extracao(self):
        ...
        while self._hoje > self._datafinal:
            dia_sl = datetime.strftime(self._hoje, "%d")
            mes_sl = datetime.strftime(self._hoje, "%m")
            ano_sl = datetime.strftime(self._hoje, "%y")
